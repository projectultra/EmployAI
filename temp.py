...
if hosting == "cloud":
    client = redis.Redis(
        ...
        port=16071,
        password="iuz2JyKXJ2kqZ0xwKS1puMu4wr7khhVi",
...
pipeline = client.pipeline()
for key, question_embedding, text_embedding in zip(
    keys, question_embeddings, text_embeddings
):
...
messages = [
    ...
    {"role": "user", "content": f"Give me 5 interview questions {role}with answers."},
]
